...
function App() {
  ...
  const [tripOptions, setTripOptions] = useState({ duration: '3 hours', style: 'Historic & local', flight: 'Best value', stay: 'Boutique hotel', food: 'Local favourites', transport: 'Walking + transit' })
      ...
      const response = await fetch(import.meta.env.VITE_AI_API_URL || 'http://localhost:8000/chat', {
        ...
        body: JSON.stringify({
          ...
          context: {
            ...
            available_minutes: Number(tripOptions.duration.split(' ')[0]) * 60,
